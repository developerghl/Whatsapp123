      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-200 hover:border-indigo-300 hover:shadow-lg transition-all duration-300">
          ...
          <div>
            ...
            <p className="text-4xl font-bold text-gray-900 mt-1">{stats.totalAccounts}</p>
          </div>
        </div>

        {/* Active Connections */}
        <div className="bg-white rounded-2xl p-6 border border-gray-200 hover:border-green-300 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center justify-between mb-4">
          ...
          <div>
            ...
            <p className="text-4xl font-bold text-green-600 mt-1">{stats.activeConnections}</p>
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-200 hover:border-purple-300 hover:shadow-lg transition-all duration-300">
          ...
          <div>
            ...
            <p className="text-4xl font-bold text-purple-600 mt-1">{stats.totalMessagesSent.toLocaleString()}</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all duration-300">
          ...
          <div>
            ...
            <p className="text-4xl font-bold text-blue-600 mt-1">{stats.totalMessagesReceived.toLocaleString()}</p>
          </div>
        </div>
      </div>
